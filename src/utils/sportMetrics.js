...
export const SPORT_METRICS = {
  Cricket: [
    ...
    { key: 'throw_distance', name: 'Throw Distance', nameTamil: 'எறியும் தூரம்', unit: 'm', inputType: 'manual', description: 'Maximum distance of a cricket ball throw', benchmarks: { 'U-14': { male: { avg: 45, good: 55, excellent: 65 }, female: { avg: 35, good: 45, excellent: 55 } }, 'U-16': { male: { avg: 55, good: 65, excellent: 75 }, female: { avg: 45, good: 55, excellent: 65 } } } },
  ],
  Football: [
  ...
  Kabaddi: [
    ...
    { key: 'hold_time', name: 'Hold Time', nameTamil: 'பிடிக்கும் நேரம்', unit: 's', inputType: 'timer', description: 'Maximum time holding a raider', benchmarks: { 'U-14': { male: { avg: 15, good: 25, excellent: 35 }, female: { avg: 12, good: 20, excellent: 30 } }, 'U-16': { male: { avg: 20, good: 30, excellent: 45 }, female: { avg: 15, good: 25, excellent: 35 } } } },
  ],
  Hockey: [
  ...
  Swimming: [
    ...
    { key: 'underwater_kick', name: 'Underwater Kick', nameTamil: 'நீருக்கடியில் உதை', unit: 'm', inputType: 'manual', description: 'Distance traveled underwater off the wall', benchmarks: { 'U-14': { male: { avg: 10, good: 12, excellent: 15 }, female: { avg: 9, good: 11, excellent: 14 } }, 'U-16': { male: { avg: 12, good: 15, excellent: 18 }, female: { avg: 11, good: 14, excellent: 17 } } } },
  ],
  Boxing: [
  ...
  Archery: [
    ...
    { key: 'bow_hold_time', name: 'Bow Hold Time', nameTamil: 'வில் பிடிக்கும் நேரம்', unit: 's', inputType: 'timer', description: 'Maximum time holding full draw', benchmarks: { 'U-14': { male: { avg: 15, good: 25, excellent: 35 }, female: { avg: 15, good: 25, excellent: 35 } }, 'U-16': { male: { avg: 20, good: 30, excellent: 45 }, female: { avg: 20, good: 30, excellent: 45 } } } },
  ],
  Weightlifting: [
    ...
    { key: 'squat_max', name: 'Squat Max', nameTamil: 'ஸ்குவாட் அதிகபட்சம்', unit: 'kg', inputType: 'manual', description: 'Maximum back squat lift weight', benchmarks: { 'U-14': { male: { avg: 50, good: 70, excellent: 90 }, female: { avg: 40, good: 55, excellent: 75 } }, 'U-16': { male: { avg: 70, good: 95, excellent: 120 }, female: { avg: 55, good: 75, excellent: 95 } } } },
  ],
};
